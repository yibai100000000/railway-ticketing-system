...
import cn.yb100.ticketservice.common.constant.Index12306Constant;
import cn.yb100.ticketservice.dao.entity.TrainDO;
import cn.yb100.ticketservice.dao.entity.TrainStationDO;
import cn.yb100.ticketservice.dao.mapper.TrainMapper;
import cn.yb100.ticketservice.dao.mapper.TrainStationMapper;
...
/**
 * 购票流程过滤器之验证参数是否有效
 * 验证参数有效这个流程会大量交互缓存，为了优化性能需要使用 Lua。这里使用多次调用缓存
 */
@Component
